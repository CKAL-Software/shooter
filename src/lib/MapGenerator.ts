...
//   addPrespawnedEnemiesToMap()

//   return { position: config.position, layout: mapLayout, teleporters, hasShop, enemies };
// }
...
// function addPrespawnedEnemiesToMap(mapLayout:string[][],rng:()=>number){

// }

// function addLoot(mapLayout:string[][],rng:()=>number){
...
// export function getPredefinedTeleporters(maps: Map<string, RandomMap>, newMapPosition: Point): Teleporter[] {
...
//   const predefinedTeleporters: (Teleporter)[] = []
...
//   if (tpBelow) predefinedTeleporters.push(tpBelow)
//   if (tpAbove) predefinedTeleporters.push(tpAbove)
//   if (tpToTheLeft) predefinedTeleporters.push(tpToTheLeft)
//   if (tpToTheRight) predefinedTeleporters.push(tpToTheRight)
